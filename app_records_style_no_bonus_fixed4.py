...
def main():
    ...
    tabs = st.tabs(["Search", "Show Detail", "Compare Two Shows", "Companies", "Analytics", "Gross Races", "Grossing Milestones", "Streak Analytics", "Holidays", "Records and Achievements", "Admin"])
    with tabs[0]:
        tab_search()
    with tabs[1]:
        tab_show_detail()
